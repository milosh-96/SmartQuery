...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SmartQuery.Web.Models.EntryEntry", b =>
                {
                    ...
                    b.HasIndex("EntryId", "RelatedEntryId")
                        .IsUnique();
            ...
            modelBuilder.Entity("SmartQuery.Web.Models.WebUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SmartQuery.Web.Models.EntryEntry", b =>
                {
                    b.HasOne("SmartQuery.Web.Models.Entry", "Entry")
                        .WithMany("RelatedEntries")
                        .HasForeignKey("EntryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SmartQuery.Web.Models.Entry", "RelatedEntry")
                        .WithMany()
